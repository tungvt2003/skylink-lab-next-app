...
const SecondarySchool = () => {
  const configBreadCrum = [
    ...
    },
    {
      ...
      url: "/chuong-trinh-dao-tao/trung-hoc-co-so",
    },
  ]
  ...
  return (
    <div className="container">
      ...
      <div className="container-curriculum-post">
        <h2 className="title-curriculum-post">bậc trung học cơ sở</h2>
        ...
        <div className="content-curriculum-post ">
          ...
          <div className="h-12" />
          <h3 className="sub-title-curriculum-post">
            CẤU TRÚC CHƯƠNG TRÌNH TRUNG HỌC CƠ SỞ
            <div className="border-sub-title-curriculum-post" />
          </h3>
          <Image src={Images.thcs2} alt="hinh-anh-content-post" />
          <div className="h-12" />

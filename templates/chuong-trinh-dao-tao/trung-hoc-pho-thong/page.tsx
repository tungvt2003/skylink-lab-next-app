  ...
  return (
    <div className="container">
      ...
      <div className="container-curriculum-post">
        <h2 className="title-curriculum-post">bậc Trung học phổ thông</h2>
        ...
        <div className="content-curriculum-post ">
          <p className="tag-p-curriculum-post">
            Với học sinh cấp Trung học phổ thông, Sky-Line chú trọng tới việc giúp học sinh khám phá thế mạnh của bản
            thân trong nhiều lĩnh vực khác nhau để từ đó sớm xác định đam mê và có định hướng nghề nghiệp đúng đắn trong
            tương lai. Đồng thời, nhà trường đặc biệt quan tâm đến việc giáo dục giới tính cho học sinh cũng như các
            hoạt động giúp cha mẹ hiểu rõ hơn sự chuyển biến tâm sinh lý của con nhằm xác định hướng giáo dục khoa học,
            phù hợp với đặc điểm của con mình. Việc giáo dục, rèn luyện gắn liền với các giá trị “Có trách nhiệm, Biết
            yêu thương, Tự lập, Hợp tác” đã trở thành văn hóa hành xử và giá trị cốt lõi của học sinh Sky-Line.
          </p>
          ...
          <div className="h-12" />
          <h3 className="sub-title-curriculum-post">
            CẤU TRÚC CHƯƠNG TRÌNH TRUNG HỌC PHỔ THÔNG
            <div className="border-sub-title-curriculum-post" />
          </h3>
          <Image src={Images.thpt2} alt="hinh-anh-content-post" />
          <div className="h-12" />

          <h3 className="sub-title-curriculum-post">
            CHƯƠNG TRÌNH PHÁT TRIỂN CÁ NHÂN TẠI SKY-LINE
            <div className="border-sub-title-curriculum-post" />
          </h3>
          <p className="tag-p-curriculum-post">
          ...
          <div className="h-3" />
          <Image src={Images.thpt3} alt="hinh-anh-content-post" />
          <div className="h-3" />

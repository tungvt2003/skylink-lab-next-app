      ...
      <div className="pt-16 pb-[6.25rem] gap-16">
        <div className="px-[7.5rem] flex flex-col gap-8 text-center">
          ...
          <Tabs defaultValue="so-tay-phhs" className="flex flex-col gap-16">
            ...
            <TabsContent value="thuc-don-hs"></TabsContent>
            <TabsContent value="so-tay-phhs" className="flex flex-col gap-16">
              <div className="font-semibold text-[2rem] leading-12">CẨM NANG PHỤ HUYNH HỌC SINH BẬC MẦM NON</div>
              <div className="flex flex-col gap-12">
                <Image src={Images.imageCamNangDetail} alt="Cẩm Nang Phụ Huynh" />
              </div>
            </TabsContent>
          </Tabs>
        </div>

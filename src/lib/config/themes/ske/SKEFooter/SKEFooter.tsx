...
import { RenderConfig, SKEFooterProps } from "./RenderConfig"
...
export const SKEFooter: ComponentConfig<SKEFooterProps> = {
  label: "SKE | Footer",
  //@ts-ignore
  fields: {
    img: {
    ...
    items: {
      ...
      label: "Items",
      type: "array",
      getItemSummary: (item, index = 0) => `${index + 1}. ${item.baseAddress && item.baseAddress}`,
      arrayFields: {
        baseAddress: {
          label: "baseAddress",
          type: "text",
  ...
  defaultProps: {
    ...
    items: [
      {
        baseAddress: "SKY-LINE Riverside (cơ sở 2)",
        location: "Lô A2.4 Đường Trần Đăng Ninh,Q. Hải Châu, TP. Đà Nẵng. ",
        phoneNumber: "(+84) 236.378.7777",
      },
      {
        baseAddress: "SKY-LINE Riverside (cơ sở 2)",
        location: "Lô A2.4 Đường Trần Đăng Ninh,Q. Hải Châu, TP. Đà Nẵng. ",
      ...
      {
        baseAddress: "SKY-LINE Riverside (cơ sở 3)",
        location: "Lô A2.4 Đường Trần Đăng Ninh,Q. Hải Châu, TP. Đà Nẵng. ",
        phoneNumber: "(+84) 236.378.7777",
      },
      {
        baseAddress: "SKY-LINE Riverside (cơ sở 4)",
        location: "Lô A2.4 Đường Trần Đăng Ninh,Q. Hải Châu, TP. Đà Nẵng. ",
        phoneNumber: "(+84) 236.378.7777",
      },
      {
        baseAddress: "SKY-LINE Riverside (cơ sở 5)",
        location: "Lô A2.4 Đường Trần Đăng Ninh,Q. Hải Châu, TP. Đà Nẵng. ",
        phoneNumber: "(+84) 236.378.7777",
      },
      {
        baseAddress: "SKY-LINE Riverside (cơ sở 6)",
        location: "Lô A2.4 Đường Trần Đăng Ninh,Q. Hải Châu, TP. Đà Nẵng. ",
        phoneNumber: "(+84) 236.378.7777",
      },
    ],

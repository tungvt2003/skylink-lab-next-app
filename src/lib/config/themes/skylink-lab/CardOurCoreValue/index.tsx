...
import { CardOurCoreValueProps, RenderConfig } from "./RenderConfig"
import styles from "./styles.module.css"

const getClassName = getClassNameFactory("CardOurCoreValue", styles)
...
export const CardOurCoreValue: ComponentConfig<CardOurCoreValueProps> = {
  label: "Card Our Core Value",
  fields: {
    image: {
      label: "Image",
      type: "custom",

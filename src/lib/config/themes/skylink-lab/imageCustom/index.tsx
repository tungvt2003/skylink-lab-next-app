...
import { ImageProps, RenderConfig } from "./RenderConfig"

const ImageCard = ({ value, onChange, label }: any) => {
...
export const ImageSKLLab: ComponentConfig<ImageProps> = {
  label: "Image Custom",
  // @ts-expect-error
  fields: {
    image: {
      label: "Banner Image",
      type: "custom",
      render: props => <ImageCard {...props} label="Banner Image" />,
    },
    maxHeight: {
      label: "Max Height",
      type: "text",
